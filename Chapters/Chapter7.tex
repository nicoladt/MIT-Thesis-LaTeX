...
%need a bit more here on how tasks represented/tested use cases from requirements analysis
...
Aside from these issues, it was evident from the formative usability tests that the interface definitely provided users with news ways of interacting with saved annotations. These included being able to filter by meaningful categories (such as subject and grade), to search for annotations made by a specific external user, and to view detailed information about a particular annotation. 

%need a bit more here on "whilst there were issues, the first interface was a decent representation of the paper prototype and def gave users brand new functionality, according to user requirements and use cases"
...
%paragraph here about how improvements fed into high level goals. Not just details. Improvements would make achieving high level goals easier, more intuitive, robust. differentiate interface elements better (e.g. username search and reset button) "Before moving onto the summative evaluation you should have a summary paragraph reviewing the changes you made with respect to the higher level goals – i.e making it easier to navigate, identify and sort"
...
%para here explaining rationale for when heuristic evaluation was undertaken (more on how it compliments usability tests?), who did it and what did I do. How did heuristic tasks map to design principles/heuristics themselves (tasks were similar to those in usability tests - tested every aspect of interface acc to heuristics)
...
%need summary para here about higher level stuff - how did heuristic findings differ or compliment earlier usability tests? Acc to hueristics, does interface allow achievement of high level goals? 
...
%something here about high level stuff - more on success of interface. It really allowed uesrs to perform new tasks - achieved its objective. 
